...
```admonish note title="เปลี่ยนจาก H1/H2 เป็นรอบปีเดียว"
...
```admonish tip title="Flagship Themes คืออะไร?"
...
```admonish info title="สนใจเสนอ Flagship Theme?"
...
```admonish note title="3 ระดับของ Team Ask"
...
```admonish warning title="หลักการ Anti-Overcommit"
...
```admonish tip title="Team Champion คือใคร?"
...
```admonish success title="ใครก็เสนอ Goal ได้"
...
```admonish success title="สนใจมีส่วนร่วม?"
...
1. [First look at 2026 Project goals](https://blog.rust-lang.org/.../first-look-at-2026.../)
2. [FLAGSHIP_TEMPLATE.md](https://github.com/.../blob/main/src/FLAGSHIP_TEMPLATE.md)
3. [project-goals/2026-workshop](https://rust-lang.zulipchat.com/...)
