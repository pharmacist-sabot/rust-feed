...
## ทำไมต้อง Rust? ทำไมไม่ใช่ Electron?
...
```admonish note title="Rust vs Electron: ตัวเลขที่พูดแทนทุกอย่าง"
...
```admonish info title="4 หลักการออกแบบหลัก"
...
## AI-Assisted Development: The Open Method
...
```admonish tip title="PRD = 10x ROI"
...
**Phase 3: Task Decomposition** — แต่เนื่องจาก project นี้ lighter และใช้ model ใหม่ ผู้พัฒนาจึงตัดสินใจข้าม task-master และทำเป็น checklist document แบบง่ายๆ เพื่อทดสอบว่า AI สามารถ handle ได้มากแค่ไหนในครั้งเดียว และผลลัพธ์ก็น่าประทับใจ

**Phase 4: Context Loading** — เนื่องจาก AI models มี training cutoffs ผู้พัฒนาจึงใช้ Context7 (MCP tool) เพื่อ pull current documentation สำหรับ Axum, Vue 3 และ Milkdown พร้อมกับสร้าง ai-context.md ซึ่งเป็น lean cheat sheet ประมาณ 100 บรรทัดที่บอก AI ว่าโค้ดควรเข้ากับ codebase อย่างไร

**Phase 5: Implementation** — build features ใน focused sessions, test, update checklist แล้ว repeat

**Phase 6: Verification** — ซึ่งเป็นหลักการสำคัญ AI เขียนโค้ด แต่คุณต้อง verify product เอง รันมัน, คลิก buttons, ลอง edge cases

```admonish warning title="อย่าไว้ใจ 'this should work'"
AI จะพูดว่า "this should work" อย่างมั่นใจทุกครั้งโดยไม่มีข้อยกเว้น ในช่วงแรกผู้พัฒนาเชื่อคำพูดนี้และก็พบว่าของมักจะพังในอีก 2 features ถัดไป วิธีแก้คือ **test everything yourself** 555, click the buttons, try the edge cases
```
...
## Game Changer: 1M Token Context Window
...
```admonish note title="200K vs 1M Tokens: ก่อนและหลัง"
...
```admonish success title="Rust's Strict Compiler = AI's Best Friend"
...
```admonish warning title="3 สิ่งที่ต้องระวังเมื่อทำงานกับ AI"
...
1. [I Built a Full Project Management App in 2 days Using Claude 4.6](https://dev.to/.../i-built-a-full-project-management-app...)
