...
## 1. The Cost of Runtime ทำไมต้องหนีจาก Electron?
...
## 2. Rust Async Runtime vs Node.js Event Loop
...
3. **No GC Pauses** เรื่องนี้สำคัญมากสำหรับงาน Real-time progress tracking เพราะ Rust ไม่มี Garbage Collector มาคอย interrupt การทำงาน ทำให้ Progress events ที่ส่งกลับไปหน้าบ้านมีความลื่นไหลและแม่นยำ
...
## 5. FFmpeg License: Process Separation
