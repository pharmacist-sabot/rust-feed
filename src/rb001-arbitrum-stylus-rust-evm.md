...
```admonish note title="Claude Code Skill คืออะไร?"
...
```admonish info title="stylus-sdk: สะพานเชื่อม Rust กับ EVM"
...
```admonish tip title="Rust Patterns ใน Smart Contract"
...
```admonish warning title="ดู Verbose แต่มีเหตุผล"
...
```admonish info title="Workflow แบบไร้รอยต่อ"
...
```admonish success title="Rust คือ 'Real Deal' ในยุคถัดไปของ Smart Contract"
